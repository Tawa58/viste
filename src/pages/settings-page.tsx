...
export function SettingsPage() {
  ...
  async function savePhoto(avatarUrl: string | undefined) {
    setForm((f) => (f ? { ...f, avatarUrl } : f))
    setSaving(true)
    try {
            ...
            <Card>
              ...
              <CardContent className="space-y-5">
                <ProfilePhotoUpload
                  ...
                  disabled={saving}
                  onChange={(avatarUrl) => void savePhoto(avatarUrl)}
                />
        ...
        <TabsContent value="appearance">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                variant="outline"
                onClick={() => toast.success('Appearance reset to school defaults (mock)')}
              >
          ...
          <TabsContent value="teaching">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button onClick={() => toast.success('Teaching preferences saved (mock)')}>
          ...
          <TabsContent value="family">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button onClick={() => toast.success('Family preferences saved (mock)')}>
          ...
          <TabsContent value="student">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Button onClick={() => toast.success('Student preferences saved (mock)')}>
            ...
            <TabsContent key={value} value={value}>
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button onClick={() => toast.success(`${title} saved (mock)`)}>Save {title}</Button>
                </CardContent>
              </Card>
            </TabsContent>
          ))}
